...
<div id="carouselExampleControls" class="carousel slide bs-slider box-slider" data-ride="carousel" data-pause="hover" data-interval="false">
	...
	<ol class="carousel-indicators">
		<section id="section05" class="demo" style="cursor: pointer">
	...
	<div class="carousel-inner" role="listbox">
		<div class="carousel-item active">
			<div id="home" class="home-section first-section " style="background-image:url('<?php echo get_template_directory_uri(); ?>/img/busjes_rimondia.png');">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="big-tagline">
									<h2>Rimondia B.V.</h2>
									<p class="lead">Rimondia is onderdeel van de Van de Ridder Groep en houd zich
										bezig met monstername en diagnose, voornamelijk in de agrarische sector.
									</p>
									<a href="" class="hover-btn-new " id="contact-button"><span>Contact </span></a>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="" class="hover-btn-new " id="over-ons-button"><span>Over ons</span></a>
								</div>
							</div>
						</div>
					</div>
		...
		<!-- <div class="carousel-item">
			<div id="home" class="first-section" style="background-image:url('<?php echo get_template_directory_uri(); ?>/img/slider-02.jpg');">
				<div class="dtab">
					<div class="container">
						<div class="row">
		...
		<div class="carousel-item">
			<div id="home" class="first-section" style="background-image:url('<?php echo get_template_directory_uri(); ?>/img/slider-03.jpg');">
				<div class="dtab">
					<div class="container">
						<div class="row">
...
<div id="monstername-section" class="section lb">
	<div class="container-fluid">
		...
		<div class="row align-items" id="switch-elements">
			<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
				<div class="post-media wow fadeIn">
					<img src="<?php echo get_template_directory_uri(); ?>/img/about_02.jpg" alt="" class="img-fluid img-rounded">
				</div>
				<!-- end media -->
			</div>
			<!-- end col -->
		...
		<div class="row align-items">
			...
			<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
				<div class="post-media wow fadeIn">
					<img src="<?php echo get_template_directory_uri(); ?>/img/about_03.jpg" alt="" class="img-fluid img-rounded">
				</div>
				<!-- end media -->
			</div>
			<!-- end col -->
				...
				<div class="timeline__items">
					...
					<?php if (have_posts()) : while (have_posts()) : the_post();
							...
							<div class="timeline__item">
								<div class="timeline__content img-bg-01 wow fadeInDown" style="background-image:url('<?php echo get_template_directory_uri(); ?>/img/img-01.jpg');">
									<h2><?php the_title(); ?></h2>
									<!-- <?php if (is_array($meta) && isset($meta['joe'])) { ?>
										<h3><?php echo $meta['joe']; ?> </h3> <?php
																			} ?> -->
									<p><?php the_content(); ?></p>
								</div>
							</div>
					...
					<div class="timeline__item">
						<div class="timeline__content wow fadeInUp" style="background-image:url('<?php echo get_template_directory_uri(); ?>/img/img-01.jpg');">
							<h2>4. Monstername</h2>
...
<div class="cl custom-paralax">
	<div id="testimonials" class="parallax section db parallax-off" style="background-image:url('<?php echo get_template_directory_uri(); ?>/img/busjes_rimondia_dark.png');">
		<div class="container-fluid">
			<div class="row text-left stat-wrap">
				<div class="col-md-4 col-sm-4 col-xs-12">
					<span style="background-color: transparent" data-scroll class=" icon_wrap effect-1 alignleft"></span>
					<p class="stat_count">45000</p>
					<h3>Monsters per week</h3>
				</div>
				<!-- end col -->
				<div class="col-md-4 col-sm-4 col-xs-12">
					<span class="global-radius icon_wrap effect-1 alignleft"></span>
					<p class="stat_count">2400000</p>
					<h3>Monsters gemeten</h3>
				</div>
				<!-- end col -->

				<div class="col-md-4 col-sm-4 col-xs-12">
					<span data-scroll class="global-radius icon_wrap effect-1 alignleft"></span>
...
<div id="vacatures-section" class="section lb" style="padding-bottom: 10px">
	<div class="container-fluid">
							...
							<?php if (have_posts()) : while (have_posts()) : the_post();
									...
									<div class="col-md-4" style="padding-bottom: 40px;">
										<div class="pricing-table pricing-table-highlighted">
											...
											<div class="timeline__content img-bg-01 wow fadeInDown pricing-table-header " style="background-image:url('<?php echo get_template_directory_uri(); ?>/img/img-01.jpg');">
											...
											<div class="pricing-table-sign-up">
												<a href="<?php echo the_permalink(); ?>" class="hover-btn-new viewVacature"><span>Bekijk vacature</span></a>
											</div>
										</div>
...
<!-- <div id="testimonials" class="parallax section db parallax-off"
        style="background-image:url('<?php echo get_template_directory_uri(); ?>/img/parallax_04.jpg');">
        <div class="container">
            <div class="section-title text-center">
                <h3>Testimonials</h3>
                <p>Lorem ipsum dolor sit aet, consectetur adipisicing lit sed do eiusmod tempor incididunt ut labore et
                    ...
                    <div class="testi-carousel owl-carousel owl-theme">
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/testi_01.png" alt="" class="img-fluid">
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/testi_02.png" alt="" class="img-fluid">
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/testi_03.png" alt="" class="img-fluid ">
                                <h4>Venanda Mercy </h4>
                            </div>
                        </div>
                        <div class="testimonial clearfix">
...
<!-- <div class="container">
	<div class="row logos">
		<div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
			<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/logo_01.png" alt="" class="img-repsonsive"></a>
		</div>
		<div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
			<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/logo_02.png" alt="" class="img-repsonsive"></a>
		</div>
		<div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
			<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/logo_03.png" alt="" class="img-repsonsive"></a>
		</div>
		<div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
			<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/logo_04.png" alt="" class="img-repsonsive"></a>
		</div>
		<div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
			<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/logo_05.png" alt="" class="img-repsonsive"></a>
		</div>
		<div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
			<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/logo_06.png" alt="" class="img-repsonsive"></a>
		</div>
	</div>
</div> -->
<!-- end container -->
